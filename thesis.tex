...
%To create table of cases and statutes, open the terminal, navigate to this directory (using cd /path/to/directory/), then execute the following (without quotes) "splitindex -- thesis -s oscola".  If that doesn't work, try "splitindex thesis -s oscola".
